package ui
{
	...
	public class HUD extends Sprite
	{
		...
		private function onAddedToStage(event:Event):void
		{
			...
			// Lives label
			livesLabel = new TextField(150, 20, "LIVES", fontScoreLabel.fontName, fontScoreLabel.fontSize, 0xffffff);
			...
			// Distance label
			distanceLabel = new TextField(150, 20, "Trek", fontScoreLabel.fontName, fontScoreLabel.fontSize, 0xffffff);
			distanceLabel.hAlign = HAlign.RIGHT;
			distanceLabel.vAlign = VAlign.TOP;
			
			distanceLabel.x = int(stage.stageWidth - distanceLabel.width - 30);
			distanceLabel.y = 5;
			...
			// Score label
			foodScoreLabel = new TextField(150, 20, "SCORE", fontScoreLabel.fontName, fontScoreLabel.fontSize, 0xffffff);
